...
def get_args():
    ...
    parser.add_argument('--use_elman_mamba2_tanh', action='store_true',
                        help='Use ElmanMamba2Tanh (Mamba2 structure WITH tanh, no R matrix)')
    parser.add_argument('--use_elman_mamba2_silu', action='store_true',
