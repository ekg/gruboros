...
echo "================================================================"
echo "  FlashRNN GRU - 1B Parameters"
echo "================================================================"
echo "  Architecture: 32 heads × 64 head_dim = 2048"
echo "  dim=2048, depth=50, expansion=1.0, ~1.06B params"
echo "  chunk_size=512, batch_size=8"
echo "  Stock upstream FlashRNN (no hacks)"
echo "================================================================"
...
/home/erikg/micromamba/envs/mingru/bin/torchrun \
    ...
    --cuda \
    --bf16 \
    2>&1 | tee "logs/flashrnn_1b_${TIMESTAMP}.log"
