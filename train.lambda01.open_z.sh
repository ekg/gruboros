...
# --- Launch Training ---
echo "Starting 1B parameter training with MORE OPEN Z-GATES"
echo "Key z-gate configuration:"
echo "  - z_bias_input: -1.0 (more open than default -2.0)"
echo "  - z_bias_hidden: 0.0 (neutral, no bias)"
echo "This should allow more plasticity and faster learning"

# Training configuration with more open z-gates
